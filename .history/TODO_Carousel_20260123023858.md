...
- This provides a smooth, premium feel

### Properties to Animate
- `transform: translateX()` - Primary animation
- `opacity` - Subtle fade during transition
- `filter` - Maintain blur on side items
...
1. **src/pages/Home.jsx**
   ...
   - Pass animation props to carousel items

2. **src/index.css**
   - Rewrite carousel positioning
...
✅ Smooth sliding animation when navigating
✅ Current container slides out
✅ Next/previous container slides in simultaneously
✅ Animation direction follows arrow direction
✅ Duration: 500-700ms
✅ Easing: cubic-bezier(0.16, 1, 0.3, 1)
✅ No snapping or abrupt transitions
✅ Desktop: peek effect visible during animation
✅ Mobile: smooth sliding, single item visible
✅ Keyboard accessible
