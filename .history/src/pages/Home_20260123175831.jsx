    ...
    <main className="body">
      ...
      <section id="hero-section">
        <div className="hero-content">
          ...
          <h2 className="hero-subheader"><span className="hero-subheader-line">Where Talent Meets</span>
    ...
    <span className="word-swap-word word-6">Possibility</span>
      ...
      <section id="about-section">
        <h1 className="about-header">
          YOUR IDENTITY <br/><span className="about-header-gradient">YOUR WORLD</span> <br/> YOUR LEGACY
        </h1>
