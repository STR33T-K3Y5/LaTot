  ...
  return (
    <>
      ...
      <section id="planet-section">
        ...
        < class="planet-subheader">Every talent deserves the perfect world. Explore our specialized planets, each designed to nurture and amplify specific skill sets and creative passions.</>
        <div class="about-carousel">
          {/* Creative Hub */}
