...
const Home = () => {
  return (
    <>
      ...
      <section id="pla-section">
        <h1 class="pla-header">Talent Planets</h1>
        <p class="pla-subheader">Every talent deserves the perfect world. Explore our specialized planets, each designed to nurture and amplify specific skill sets and creative passions.</p>
        <div class="about-carousel">
          {/* Creative Hub */}
          <div class="pla-item">
            <h1 class="planet-header"></h1>
            <h2 class="pla-subheader">Headshot</h2>
            <p class="pla-description">In the LATOT multiverse, your professional identity is your passport. A compelling headshot is more than a photograph—it's your introduction to a universe of opportunities. Showcase your authentic self and stand out among the stars.</p>
          </div>
          {/* Planet */}
          <div class="pla-item">
            <h1 class="planet-header"></h1>
            <h2 class="pla-subheader">Planet</h2>
            <p class="pla-description">Every talent has its habitat. Find the perfect environment where your skills can flourish. From digital metropolises to creative sanctuaries, LATOT connects you with worlds designed for your unique abilities.</p>
          </div>
          {/* Palace */}
          <div class="pla-item">
            <h1 class="planet-header"></h1>
            <h2 class="pla-subheader">Palace</h2>
            <p class="pla-description">Rise to prominence in your chosen domain. The palace represents the pinnacle of achievement—where your talents are recognized, rewarded, and celebrated. Build your legacy in the heart of the LATOT multiverse.</p>
          </div>
        </div>
      </section> 
