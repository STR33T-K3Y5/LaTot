  ...
  return (
    <>
      ...
      <section id="c-section">
        <h1 class="c-header">YOUR IDENTITY, YOUR WORLD, YOUR LEGACY</h1>
        <p class=ct-subheader">How LaTot Works For You</p>
        <div class="core-carousel">
          {/* Headshot */}
          <div class="core-item">
            <h1 class="c-header">Technology</h1>
            <p class="c-description">In the LATOT multiverse, your professional identity is your passport. A compelling headshot is more than a photograph—it's your introduction to a universe of opportunities. Showcase your authentic self and stand out among the stars.</p>
          </div>
          {/* Planet */}
          <div class="core-item">
            <h1 class="c-header">Creative Arts</h1>
            <p class="c-description">Every talent has its habitat. Find the perfect environment where your skills can flourish. From digital metropolises to creative sanctuaries, LATOT connects you with worlds designed for your unique abilities.</p>
          </div>
          {/* Palace */}
          <div class="core-item">
            <h1 class="c-header">Finance</h1>
            <p class="c-description">Rise to prominence in your chosen domain. The palace represents the pinnacle of achievement—where your talents are recognized, rewarded, and celebrated. Build your legacy in the heart of the LATOT multiverse.</p>
          </div>
          {/* Headshot */}
          <div class="core-item">
            <h1 class="c-header">Technology</h1>
