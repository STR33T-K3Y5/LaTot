...
const Home = () => {
  return (
    <>
      ...
      <section id="abo-section">
        <h1 class="abo-header">The LATOT Multiverse</h1>
        <h2 class="abo-subheader">Infinite Worlds, One Community</h2>
        <p class="abo-description">Where boundaries dissolve and possibilities expand. The LATOT multiverse connects talent, opportunity, and innovation across countless interconnected worlds.</p>
        <div class="abo-carousel">
          {/* Our Worlds */}
            <h1 class="abo-header">Discover Our Worlds</h1>
            <p class="abo-description">The LATOT multiverse is a tapestry of interconnected worlds, each offering unique opportunities, communities, and experiences for citizens from all walks of life.</p>
          {/* A Universe of Possibilities */}
          <div class="abo-item">
            <h1 class="abo-header">A Universe of Possibilities</h1>
            <p class="abo-description">Every world in the LATOT multiverse is designed to foster growth, creativity, and collaboration. Whether you're a creator, innovator, or leader, there's a place for you here.</p>
            <p class="abo-description">Cross-dimensional travel is seamless, allowing you to explore, connect, and contribute across all our worlds without barriers.</p>
          </div>
          {/* Collaboration Without Borders */}
          <div class="abo-item">
            <h1 class="abo-header">Collaboration Without Borders</h1>
            <p class="abo-description">The LATOT multiverse was built on the belief that great things happen when talented individuals from different worlds come together.</p>
            <p class="abo-description">Our collaborative platforms break down barriers, enabling seamless teamwork across sectors, planets, and dimensions. Whatever your vision, find the right partners to bring it to life.</p>
            <ul class="tick-list">
