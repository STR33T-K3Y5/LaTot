  ...
  return (
    ...
    <main className="body">
      ...
      <section id="hero-section">
        ...
        <h2 className="hero-subheader">Where Talent Meets Opportunity</h2>
        <p className="hero-text">Discover a universe of possibilities where your skills, creativity, and passion converge with endless opportunities across the multiverse.</p>
        <button>
