...
const Home = () => {
  return (
    <>
      ...
      <section id="plane-section">
        <h1 class="plane-header">Talent Planets</h1>
        <p class="plane-subheader">Every talent deserves the perfect world. Explore our specialized planets, each designed to nurture and amplify specific skill sets and creative passions.</p>
        <div class="about-carousel">
          {/* Creative Hub */}
          <div class="plane-item">
            <h1 class="planet-header"></h1>
            <h2 class="plane-subheader">Headshot</h2>
            <p class="plane-description">In the LATOT multiverse, your professional identity is your passport. A compelling headshot is more than a photograph—it's your introduction to a universe of opportunities. Showcase your authentic self and stand out among the stars.</p>
          </div>
          {/* Planet */}
          <div class="plane-item">
            <h1 class="planet-header"></h1>
            <h2 class="plane-subheader">Planet</h2>
          ...
          <div class="plane-item">
            <h1 class="planet-header"></h1>
            <h2 class="plane-subheader">Palace</h2>
            <p class="plane-description">Rise to prominence in your chosen domain. The palace represents the pinnacle of achievement—where your talents are recognized, rewarded, and celebrated. Build your legacy in the heart of the LATOT multiverse.</p>
          </div>
        </div>
      </section> 
