  ...
  return (
    <>
      ...
      <section id="about-section">
        ...
        <p class="about-description">Where boundaries dissolve and possibilities expand. The LATOT multiverse connects talent, opportunity, and innovation across countless interconnected worlds.</p>
        <div class="about-carousel">
          {/* Our Worlds */}
            <h1 class="about-header">Discover Our Worlds</h1>
            <p class="about-description">The LATOT multiverse is a tapestry of interconnected worlds, each offering unique opportunities, communities, and experiences for citizens from all walks of life.</p>
          {/* A Universe of Possibilities */}
          <div class="about-item">
            <h1 class="about-header">A Universe of Possibilities</h1>
            <p class="about-description">Every world in the LATOT multiverse is designed to foster growth, creativity, and collaboration. Whether you're a creator, innovator, or leader, there's a place for you here.</p>
            <p class="about-description">Cross-dimensional travel is seamless, allowing you to explore, connect, and contribute across all our worlds without barriers.</p>
          </div>
          {/* Collaboration Without Borders */}
          <div class="about-item">
            <h1 class="about-header">Collaboration Without Borders</h1>
            <p class="about-description">The LATOT multiverse was built on the belief that great things happen when talented individuals from different worlds come together.</p>
            <p class="about-description">Our collaborative platforms break down barriers, enabling seamless teamwork across sectors, planets, and dimensions. Whatever your vision, find the right partners to bring it to life.</p>
            <ul class="tick-list">
      ...
      <section id="join-section">
        <div class="contact-container">
          ...
          <button class="contact-cta-button">
            <a href="mailto:info@latotofficial.com">Become A Citize</a>
          </button>
        </div>
      </section>
