  ...
  return (
    <>
      ...
      <section id="core-section">
        <h1 class="core-header">YOUR IDENTITY, YOUR WORLD, YOUR LEGACY</h1>
        <p class=coret-subheader">How LaTot Works For You</p>
        <div class="core-carousel">
          {/* Headshot */}
          <div class="core-item">
            <h1 class="core-header">Technology</h1>
            <p class="core-description">In the LATOT multiverse, your professional identity is your passport. A compelling headshot is more than a photograph—it's your introduction to a universe of opportunities. Showcase your authentic self and stand out among the stars.</p>
          </div>
          {/* Planet */}
          <div class="core-item">
            <h1 class="core-header">Creative Arts</h1>
            <p class="core-description">Every talent has its habitat. Find the perfect environment where your skills can flourish. From digital metropolises to creative sanctuaries, LATOT connects you with worlds designed for your unique abilities.</p>
          </div>
          {/* Palace */}
          <div class="core-item">
