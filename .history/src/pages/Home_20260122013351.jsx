  ...
  return (
    <>
      ...
      <section id="abo-section">
        <h1 class="abo-header">Talent Planets</h1>
        <p class="abo-subheader">Every talent deserves the perfect world. Explore our specialized planets, each designed to nurture and amplify specific skill sets and creative passions.</p>
        <div class="about-carousel">
          {/* Creative Hub */}
          <div class="abo-item">
            <h1 class="planet-header"></h1>
            <h2 class="abo-subheader">Headshot</h2>
            <p class="abo-description">In the LATOT multiverse, your professional identity is your passport. A compelling headshot is more than a photograph—it's your introduction to a universe of opportunities. Showcase your authentic self and stand out among the stars.</p>
          </div>
          {/* Planet */}
          <div class="abo-item">
            <h1 class="planet-header"></h1>
            <h2 class="abo-subheader">Planet</h2>
            <p class="abt-description">Every talent has its habitat. Find the perfect environment where your skills can flourish. From digital metropolises to creative sanctuaries, LATOT connects you with worlds designed for your unique abilities.</p>
          </div>
          {/* Palace */}
          <div class="abo-item">
            <h1 class="planet-header"></h1>
            <h2 class="abo-subheader">Palace</h2>
            <p class="abo-description">Rise to prominence in your chosen domain. The palace represents the pinnacle of achievement—where your talents are recognized, rewarded, and celebrated. Build your legacy in the heart of the LATOT multiverse.</p>
          </div>
        </div>
      </section> 
