...
const Home = () => {
  return (
    <>
      ...
      <section id="-section">
        <h1 class="-header">Talent Planets</h1>
        <p class="-subheader">Every talent deserves the perfect world. Explore our specialized planets, each designed to nurture and amplify specific skill sets and creative passions.</p>
        <div class="about-carousel">
          {/* Creative Hub */}
          <div class="-item">
            <h1 class="planet-header"></h1>
            <h2 class="-subheader">Headshot</h2>
            <p class="-description">In the LATOT multiverse, your professional identity is your passport. A compelling headshot is more than a photograph—it's your introduction to a universe of opportunities. Showcase your authentic self and stand out among the stars.</p>
          </div>
          {/* Planet */}
          <div class="-item">
            <h1 class="planet-header"></h1>
            <h2 class="-subheader">Planet</h2>
          ...
          <div class="-item">
            <h1 class="planet-header"></h1>
            <h2 class="-subheader">Palace</h2>
            <p class="-description">Rise to prominence in your chosen domain. The palace represents the pinnacle of achievement—where your talents are recognized, rewarded, and celebrated. Build your legacy in the heart of the LATOT multiverse.</p>
          </div>
        </div>
      </section> 
