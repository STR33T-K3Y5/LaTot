      ...
      <section id="planet-section">
        ...
        <div class="about-carousel">
          ...
          <div class="planet-item">
            ...
            <h2 class="planet-subheader">Headshot</h2>
            <p class="planet-description">In the LATOT multiverse, your professional identity is your passport. A compelling headshot is more than a photograph—it's your introduction to a universe of opportunities. Showcase your authentic self and stand out among the stars.</p>
          </div>
          {/* Planet */}
          <div class="planet-item">
            <h1 class="planet-header"></h1>
            <h2 class="planet-subheader">Planet</h2>
            <p class=planett-description">Every talent has its habitat. Find the perfect environment where your skills can flourish. From digital metropolises to creative sanctuaries, LATOT connects you with worlds designed for your unique abilities.</p>
          </div>
          {/* Palace */}
          <div class="planet-item">
            <h1 class="planet-header"></h1>
