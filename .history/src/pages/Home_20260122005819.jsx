  ...
  return (
    <>
      ...
      <section id="abo-section">
        <h1 class="abo-header">YOUR IDENTITY, YOUR WORLD, YOUR LEGACY</h1>
        <p class="abt-subheader">How LaTot Works For You</p>
        <div class="core-carousel">
          {/* Headshot */}
          <div class="core-item">
            <h1 class="abo-header">Technology</h1>
          ...
          {/* Planet */}
          <div class="core-item">
            <h1 class="abo-header">Creative Arts</h1>
            <p class="abo-description">Every talent has its habitat. Find the perfect environment where your skills can flourish. From digital metropolises to creative sanctuaries, LATOT connects you with worlds designed for your unique abilities.</p>
          </div>
          {/* Palace */}
          <div class="core-item">
            <h1 class="abo-header">Finance</h1>
