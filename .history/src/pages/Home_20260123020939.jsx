...
const Home = () => {
  ...
  const aboutItems = [
    {
      ...
      title: 'Headshot',
      description: 'In the LATOT multiverse, your professional identity is your passport. A compelling headshot is more than a photograph—it's your introduction to a universe of opportunities. Showcase your authentic self and stand out among the stars.'
    },
    {
      id: 'planet',
  ...
  const nextAboutSlide = () => {
    goToAboutSlide(aboutCurrentIndex + 1, 'next');
  };

  const prevAboutSlide = () => {
    goToAboutSlide(aboutCurrentIndex - 1, 'prev');
  };
