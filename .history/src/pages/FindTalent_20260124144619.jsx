...
import Navbar from '../components/TalentNavbar';
...
const FindTalent = () => {
  ...
  const filteredPeople = useMemo(() => {
    return people.filter(person => {
      ...
      // Years of Experience filter - wired directly to yearsexperience field
      if (filters.experience && filters.experience !== 'all') {
        const years = person.yearsexperience ?? 0;
        if (filters.experience === '0-2' && years > 2) {
          return false;
        }
        if (filters.experience === '3-6' && (years < 3 || years > 6)) {
          return false;
        }
        if (filters.experience === '7+' && years < 7) {
          return false;
        }
      }
