...
- [ ] 1.1 Add animation states for navigating RIGHT
  - Center item: translateX(-100%)
  - Next item: translateX(0) from 100%
- [ ] 1.2 Add animation states for navigating LEFT
  - Center item: translateX(100%)
  - Prev item: translateX(0) from -100%
- [ ] 1.3 Add cubic-bezier easing (0.16, 1, 0.3, 1)
- [ ] 1.4 Set duration to 500ms
- [ ] 1.5 Ensure side items stay fixed during animation

### Phase 2: React Component Updates
- [ ] 2.1 Verify animation guard clause works
- [ ] 2.2 Add accessibility improvements (aria-hidden)
- [ ] 2.3 Verify timing sync between JS and CSS
